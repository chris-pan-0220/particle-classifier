...
class ParticleDataGenerator:
    ...
    def generate_data(self, category_mean_diff:float=0, std_dev_ratio:float=1, category_ratio:float=1):
        ...
        # debug: visualize 2D random variable
        if debug:
            plot2Dhistogram(c1_stacked[0], c2_stacked[0])
        # for i in range(3):
